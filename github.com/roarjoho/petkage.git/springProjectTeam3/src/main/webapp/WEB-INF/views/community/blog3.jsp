							...
							<table class="table"
								...
								<tr class="pageNumber">
									<td colspan="7" align="center"><c:if
											...
											<a href="${pageContext.request.contextPath}/community/blog3?boardCategory_number=${boardDTO.boardCategory_number}&pageNum=${pageDTO.startPage-pageDTO.pageBlock}">[이전]</a>
										</c:if> <c:forEach var="i" begin="${pageDTO.startPage }"
											end="${pageDTO.endPage }" step="1">
											<a href="${pageContext.request.contextPath}/community/blog3?boardCategory_number=${boardDTO.boardCategory_number}&pageNum=${i}">${i}
											</a>
										</c:forEach> <c:if test="${pageDTO.endPage < pageDTO.pageCount }">
											<a href="${pageContext.request.contextPath}/community/blog3?boardCategory_number=${boardDTO.boardCategory_number}&pageNum=${pageDTO.startPage+pageDTO.pageBlock}">[다음]</a>
										</c:if></td>
