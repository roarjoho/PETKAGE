...
<head>
	...
	$(document).ready(function () {
		 $(document).on("click", "button[name='btnSave']", function () {
		    ...
		    var categorySelect = $("select[name='categorySelect']");
		...
		<div>
				     ...
				     <article>
						...
						<div class="container" role="main"><br>
							...
							<h3 class="font1">글작성 (후기/정보공유/사진)</h3><br><br><br>
							
							<form method="post" action="${pageContext.request.contextPath}/community/blogWritePro" enctype="multipart/form-data">
								
								<input type="hidden" value="${BoardContentView.board_numberID}" name="board_numberID">
							
								<h6 class="font1">카테고리 선택(필수)<label style="color:red;">*</label></h6><br>
								<select class="form-select" aria-label="Default select example" name="categorySelect">
								  <option selected value="0">Category</option>
								  <option value="1">후기</option>
								  <option value="2">정보공유</option>
								  <option value="3">자랑(사진)</option>
								</select>
								<br>
								...
								<div class="mb-3">
									...
									<label for="file">이미지</label><label style="color:red;">*</label>
								...
								<div>
									...
									<button type="button" class="listBtn" id="btnList" 
