	...
	<section class="blog-section spad">
		<div class="container">			
				...
				<div class="col-lg-9 order-1 order-lg-2">
					<div class="container">
					<div>
					<h5 class="font1" style="padding-bottom: 10px;">내 사진한컷 보기</h5>
					<select id="boardSelectOption" onchange="location.href=this.value" class="form-select">
						...
						<option selected="selected" value="${pageContext.request.contextPath}/mypage/mypageBoard3">자랑(사진)</option>
					</select>
					</div>
											...
											<tr><td colspan="5">등록된 글이 없습니다</td></tr>
			                             	...
			                             	<tr class="pageNumber">
			                             		<td colspan="5" align="center">
													...
													<a href="${pageContext.request.contextPath}/mypage/mypageBoard3?pageNum=${pageDTO.startPage-pageDTO.pageBlock}">[이전]</a>
													</c:if>
													...
													<a href="${pageContext.request.contextPath}/mypage/mypageBoard3?pageNum=${pageDTO.startPage+pageDTO.pageBlock}">[다음]</a>
													</c:if>
			                             		</td>
			                             	</tr>	
