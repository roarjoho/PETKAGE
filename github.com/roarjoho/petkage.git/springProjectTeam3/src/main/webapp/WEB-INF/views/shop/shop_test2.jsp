...
<head>
	...
	$( document ).ready(function() {
		$('#sorting').on('change',function(){
			...
			$.getJSON('${pageContext.request.contextPath}/shop/shopOrderby?productCategory_number=2&sorting='+sorting,function(rdata){
                ...
                <div class="col-lg-3 col-md-6 col-sm-8 order-2 order-lg-1 produts-sidebar-filter">
                    <div class="filter-widget">
                        ...
                        <ul class="filter-catagories">
                            ...
                            <li><a href="${pageContext.request.contextPath}/shop/shop_test2?productCategory_number=2">고양이</a></li>
                        </ul>
                    </div>
<!--                     <div class="filter-widget"> -->
