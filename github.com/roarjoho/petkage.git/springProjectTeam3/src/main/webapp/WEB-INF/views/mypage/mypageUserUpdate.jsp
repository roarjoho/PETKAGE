			                    ...
			                    <div class="register-form">
			                        ...
			                        <form action="${pageContext.request.contextPath}/mypage/mypageUserUpdatePro" method="post">
			                            <div class="group-input">
			                                <label for="userId">아이디</label><label style="color:red;">*</label>
			                                <input type="text" id="id" name="id" readonly value=${orderInfoList.user_id }>
			                            </div>
			                            
			                            <div class="group-input">
			                                <label for="pass">비밀번호</label><label style="color:red;">*</label>
			                                <input type="password" id="pass" name="pass">
			                            </div>
			                            
			                            <div class="group-input">
			                                <label for="con-pass">비밀번호 확인</label><label style="color:red;">*</label>
			                                <input type="password" id="con_pass" name="con_pass">
			                            </div>
			                            
			                             <div class="group-input">
			                                <label for="username">이름</label><label style="color:red;">*</label>
...
<!-- 			                            </div> -->
			                             ...
			                             <div class="group-input">
			                                <label for="phone">휴대폰번호</label><label style="color:red;">*</label>
