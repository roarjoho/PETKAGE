                                ...
                                <ul class="order-table">
                                    ...
                                    <c:if test="${cartSelectList ne null}">
                                    	<c:forEach var="cartSelectList" varStatus="status" items="${cartSelectList}">
                                    		<li class="fw-normal">${cartSelectList.product_name} X ${cartSelectList.cart_count }<span id="price">${cartSelectList.product_price*cartSelectList.cart_count}</span></li>
                                   		</c:forEach>
                                    </c:if>
                                    <li class="total-price">Total <span><c:if test="${cartSelectList.size() ne null}">
                                    											<c:forEach var="i" begin="0" end="${cartSelectList.size()-1 }" step="1">
                                    												...
                                    												<c:set var="totalStock" value="${totalStock+cartSelectList.get(i).cart_count }"/>
                                    											</c:forEach>
...
<!--                     orderinfo 테이블로 전달할 값 -->
                    <input type="hidden" value="${cartSelectList.get(0).product_number}" name="product_number" id="product_number">
                    <input type="hidden" value="${sessionScope.id }" name="sessionScopeId" id="sessionScopeId">
                    <input type="hidden" value="${cartSelectList.get(0).product_name} 등 ${cartSelectList.size()}개" name="product_name" id="product_name">
                    <input type="hidden" value="${total2 }" name="priceTotal" id="priceTotal">
                    <input type="hidden" value="${totalStock}" name="product_stock" id="product_stock">
