         ...
         <div class="container-fluid">
               ...
               <div class="col-sm-12 p-0">
                  <div class="main-header">
                     <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/admin/userList">회원 목록 조회</a>
                        </li>
                     </ol>
                  </div>
               </div>
            ...
            <div class="row">
                              ...
                              <table class="table table-hover">
                                 ...
                                 <tbody>
	                                 ...
	                                 <input type="hidden" id="user_id" value="${userDTO.user_id }">
	                                    <tr>
	                                       <td onclick="location.href='${pageContext.request.contextPath }/admin/userInfo?user_id=${userDTO.user_id}'">${userDTO.user_id }</td>
	                                       <td onclick="location.href='${pageContext.request.contextPath }/admin/userInfo?user_id=${userDTO.user_id}'">${userDTO.user_name }</td>
	                                       <td onclick="location.href='${pageContext.request.contextPath }/admin/userInfo?user_id=${userDTO.user_id}'">${userDTO.user_phone }</td>
	                                       <td onclick="location.href='${pageContext.request.contextPath }/admin/userInfo?user_id=${userDTO.user_id}'">${userDTO.user_createDate }</td>
	                                       <td><input type="button" value="회원삭제" class="btn btn-danger waves-effect waves-light" onclick="deleteBtn();"></td>                                     
	                                    </tr>
	                                 </c:forEach>
                                 </tbody>                                   
                              </table>                              
             ...
             <c:if test="${pageDTO.startPage > pageDTO.pageBlock }">
				<a href="${pageContext.request.contextPath}/admin/userList?pageNum=${pageDTO.startPage-pageDTO.pageBlock}">[이전]</a>
			  </c:if>
			 <c:forEach var="i" begin="${pageDTO.startPage }" end="${pageDTO.endPage }" step="1">
				<a href="${pageContext.request.contextPath}/admin/userList?pageNum=${i}">${i} </a>
			 </c:forEach>
			 <c:if test="${pageDTO.endPage < pageDTO.pageCount }">
				<a href="${pageContext.request.contextPath}/admin/userList?pageNum=${pageDTO.startPage+pageDTO.pageBlock}">[다음]</a>
			 </c:if>
