               ...
               <div class="col-sm-12 p-0">
                  <div class="main-header">
                     <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/admin/boardList2">정보공유 게시판 관리</a>
                        </li>
                     </ol>
                  </div>
               </div>
 			...
 			<div class="row">
				<div class="col-sm-2">
				        <select class="form-control" id="categoryFilter" onchange="categoryFilter();">
				            ...
				            <option value="2" selected>정보공유 게시판</option>
               ...
               <div class="col-sm-12">					                                
                  <div class="card">          
							...
							<c:if test="${pageDTO.startPage > pageDTO.pageBlock }">
								<a href="${pageContext.request.contextPath}/admin/boardList2?pageNum=${pageDTO.startPage-pageDTO.pageBlock}">[이전]</a>
							</c:if>
							<c:forEach var="i" begin="${pageDTO.startPage }" end="${pageDTO.endPage }" step="1">
								<a href="${pageContext.request.contextPath}/admin/boardList2?pageNum=${i}">${i} </a>
							</c:forEach>
							<c:if test="${pageDTO.endPage < pageDTO.pageCount }">
								<a href="${pageContext.request.contextPath}/admin/boardList2?pageNum=${pageDTO.startPage+pageDTO.pageBlock}">[다음]</a>
							</c:if>                 				             				
            			</div>
         			</div>
      			</div>
